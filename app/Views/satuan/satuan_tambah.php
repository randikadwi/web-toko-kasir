...
<div class="container">
    ...
    <div class="row mt-5">
        <div class="col-8 mx-auto">
            <form action="<?= base_url() ?>/satuan/satuan_save" method="post">
                <h3 class="mb-5">Form Tambah Satuan : </h3>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      ...
                      ?>" placeholder="id satuan" readonly>
                        <input type="hidden" class="form-control rad-30" id="id_satuan" name="id_satuan"
                            placeholder="id satuan" readonly>

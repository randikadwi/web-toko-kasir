...
<div class="container">
    ...
    <div class="row mt-5">
        <div class="col-8 mx-auto">
            <form action="<?= base_url() ?>/barang/barang_update/<?= $barang['id_barang'] ?>" method="post">
                <h3 class="mb-5">Form Ubah barang : </h3>
               ...
               <?= csrf_field() ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control rad-30 <?= ($validation->hasError('nama')) ? 'is-invalid' : '' ?>" id="nama" name="nama" value="<?= (old('nama')) ? old('nama') : $barang['nama'] ?>" autofocus >
                          ...
                          <?php $i = 1; foreach ($kategori as $b) { ?>
                              ...
                              <?php 
                                if (old('id_kategori')) {
                                  ...
                                  if (($barang['id_kategori']) == $b['id_kategori']){
                                    echo "selected";
                                  }
                                }
                              ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      ...
                      <select class="form-control rad-30 <?= ($validation->hasError('id_satuan')) ? 'is-invalid' : '' ?>" id="id_satuan" name="id_satuan">
                          ...
                          <!-- perulangan untuk menampilkan data satuan yang telah terdaftar -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="number" class="form-control rad-30 <?= ($validation->hasError('harga')) ? 'is-invalid' : '' ?>" id="harga" name="harga" placeholder="contoh: 30000" value="<?= (old('harga')) ? old('harga') : $barang['harga'] ?>" autofocus onblur="calculate('harga', 'jumlah', 'harga_total')" >
                      <div class="invalid-feedback">
